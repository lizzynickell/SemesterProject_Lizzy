...
*Figure 4: Resulting Polygons for each pig overlaid on a map of Switzerland.* \<span style="color: #00cef6;"\>Blue \</span\> *indicates male pigs,* \<span style="color: #aff000;"\>Green \</span\> *indicates female pigs.*
